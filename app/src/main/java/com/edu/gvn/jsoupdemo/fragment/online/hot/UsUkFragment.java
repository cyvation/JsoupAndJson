 ...
 */
public class UsUkFragment extends BaseFragment implements IRecyclerViewOnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_hotmusic_ushot, container, false);
