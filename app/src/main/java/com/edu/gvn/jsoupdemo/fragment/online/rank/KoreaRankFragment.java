 ...
 */
public class KoreaRankFragment extends BaseFragment implements View.OnClickListener, RankAsync.IRankDataCallBack {
    ...
    public void onAttach(Context context) {
        ...
        rankAsync.execute(Mp3ZingBaseUrl.BXH_KOREA);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) v.findViewById(R.id.fragment_rank_general_name)).setText(R.string.rank_korean);
